...
from prompt import get_final_prompt, is_connectivity_issue, has_country, is_device
...
async def main(message: cl.Message):
    ...
    if is_connectivity_issue(user_answer) == True:
        ...
        fp = get_final_prompt(user_answer, my_retriever, my_tokenizer, convo_history, instruction)
